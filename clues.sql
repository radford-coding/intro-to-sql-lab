...
SELECT *
FROM (
    SELECT countrycode FROM countrylanguages WHERE language = 'Italian'
) a
...
-- Write SQL query here
-- SELECT * from cities WHERE name LIKE 'Serr%' AND name <> 'Serravalle';
SELECT name from countries WHERE code = (
    SELECT countrycode FROM cities WHERE name LIKE 'Serr%' AND name <> 'Serravalle'
);
